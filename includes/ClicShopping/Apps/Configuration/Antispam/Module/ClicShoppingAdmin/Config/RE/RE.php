 ...
 */
  ...
  namespace ClicShopping\Apps\Configuration\Antispam\Module\ClicShoppingAdmin\Config\RE;

  class RE extends \ClicShopping\Apps\Configuration\Antispam\Module\ClicShoppingAdmin\Config\ConfigAbstract {
    ...
    protected function init() {
        ...
        $this->is_installed = defined('CLICSHOPPING_APP_ANTISPAM_RE_RECAPTCHA_STATUS') && (trim(CLICSHOPPING_APP_ANTISPAM_RE_RECAPTCHA_STATUS) != '');
    }
