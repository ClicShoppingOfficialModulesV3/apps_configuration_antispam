 ...
 */
  ...
  class cap_create_account_pro_numeric_antispam {
    ...
    public function __construct() {
      ...
      if (\defined('MODULES_CREATE_ACCOUNT_PRO_NUMERIC_ANTISPAM_STATUS')) {
        $this->sort_order = (int)MODULES_CREATE_ACCOUNT_PRO_NUMERIC_ANTISPAM_SORT_ORDER;
        $this->enabled = (MODULES_CREATE_ACCOUNT_PRO_NUMERIC_ANTISPAM_STATUS == 'True');
      }

      if ((!\defined('CLICSHOPPING_APP_ANTISPAM_AM_NUMERIC_STATUS') || CLICSHOPPING_APP_ANTISPAM_AM_NUMERIC_STATUS == 'False') && (!\defined('CLICSHOPPING_APP_ANTISPAM_CREATE_ACCOUNT_PRO') || CLICSHOPPING_APP_ANTISPAM_CREATE_ACCOUNT_PRO == 'False')) {
         $this->enabled = false;
      }
    }
