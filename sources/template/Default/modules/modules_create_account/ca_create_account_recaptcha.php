 ...
 */
  ...
  class ca_create_account_recaptcha {
    ...
    public function __construct() {
      ...
      if (!defined('CLICSHOPPING_APP_ANTISPAM_RE_RECAPTCHA_STATUS') || CLICSHOPPING_APP_ANTISPAM_RE_RECAPTCHA_STATUS == 'False' || CLICSHOPPING_APP_ANTISPAM_CREATE_ACCOUNT == 'False') {
         $this->enabled = false;
      }
