 ...
 */
  ...
  class cg_create_guest_account_numeric_antispam {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function execute() {
      ...
      if (isset($_GET['Account'] ) && isset($_GET['CreateGuestAccount']) && !isset($_GET['Success']) ) {
        ...
        ob_start();
        require_once($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/create_guest_account_numeric_antispam'));
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_SORT_ORDER',
    ...
    public function keys() {
      return ['MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_STATUS',
              'MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_CONTENT_WIDTH',
              'MODULES_CREATE_GUEST_ACCOUNT_NUMERIC_ANTISPAM_SORT_ORDER'
             ];
    }
  }
