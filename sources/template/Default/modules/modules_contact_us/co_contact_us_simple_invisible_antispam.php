 ...
 */
  ...
  class co_contact_us_simple_invisible_antispam {
    ...
    public function __construct() {
      ...
      if ((!defined('CLICSHOPPING_APP_ANTISPAM_INVISIBLE') || CLICSHOPPING_APP_ANTISPAM_INVISIBLE == 'False') || (!defined('CLICSHOPPING_APP_ANTISPAM_CONTACT') && CLICSHOPPING_APP_ANTISPAM_CONTACT == 'False')) {
        $this->enabled = false;
      }
    }
    ...
    public function check() {
      return defined('MODULES_CONTACT_US_SIMPLE_INVISIBLE_ANTISPAM_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CONTACT_US_SIMPLE_INVISIBLE_ANTISPAM_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CONTACT_US_SIMPLE_INVISIBLE_ANTISPAM_SORT_ORDER',
    ...
    public function keys() {
      return ['MODULES_CONTACT_US_SIMPLE_INVISIBLE_ANTISPAM_STATUS',
              'MODULES_CONTACT_US_SIMPLE_INVISIBLE_ANTISPAM_SORT_ORDER'
             ];
    }
  }
